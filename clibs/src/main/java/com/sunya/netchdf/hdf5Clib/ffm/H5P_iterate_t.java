...
/**
 * {@snippet :
 * int (*H5P_iterate_t)(long id,char* name,void* iter_data);
 * }
 */
public interface H5P_iterate_t {
    ...
    static MemorySegment allocate(H5P_iterate_t fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$222.const$3, fi, constants$42.const$5, scope);
    }
    static H5P_iterate_t ofAddress(MemorySegment addr, Arena arena) {
