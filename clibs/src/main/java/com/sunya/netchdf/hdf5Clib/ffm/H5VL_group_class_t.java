 ...
 *     herr_t (*get)(void*,H5VL_group_get_t,hid_t,void**,struct __va_list_tag*);
 *     herr_t (*specific)(void*,H5VL_group_specific_t,hid_t,void**,struct __va_list_tag*);
 *     herr_t (*optional)(void*,H5VL_group_optional_t,hid_t,void**,struct __va_list_tag*);
 ...
 * void* (*create)(void*,const H5VL_loc_params_t*,char*,hid_t,hid_t,hid_t,hid_t,void**);
    ...
    public interface create {
        ...
        static MemorySegment allocate(create fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$303.const$3, fi, constants$303.const$2, scope);
        }
        static create ofAddress(MemorySegment addr, Arena arena) {
            ...
            return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1, java.lang.foreign.MemorySegment __x2, long __x3, long __x4, long __x5, long __x6, java.lang.foreign.MemorySegment __x7) -> {
                try {
                    return (java.lang.foreign.MemorySegment)constants$303.const$4.invokeExact(symbol, __x0, __x1, __x2, __x3, __x4, __x5, __x6, __x7);
                } catch (Throwable ex$) {
 ...
 * void* (*open)(void*,const H5VL_loc_params_t*,char*,hid_t,hid_t,void**);
    ...
    public interface open {
        ...
        static MemorySegment allocate(open fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$304.const$0, fi, constants$291.const$0, scope);
        }
 ...
 * herr_t (*get)(void*,H5VL_group_get_t,hid_t,void**,struct __va_list_tag*);
    ...
    public interface get {
        ...
        static MemorySegment allocate(get fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$304.const$2, fi, constants$292.const$4, scope);
        }
 ...
 * herr_t (*specific)(void*,H5VL_group_specific_t,hid_t,void**,struct __va_list_tag*);
    ...
    public interface specific {
        ...
        static MemorySegment allocate(specific fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$304.const$4, fi, constants$292.const$4, scope);
        }
 ...
 * herr_t (*optional)(void*,H5VL_group_optional_t,hid_t,void**,struct __va_list_tag*);
    ...
    public interface optional {
        ...
        static MemorySegment allocate(optional fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$305.const$0, fi, constants$292.const$4, scope);
        }
    ...
    public static MemorySegment optional$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$305.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment optional$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$305.const$1.get(seg.asSlice(index*sizeof()));
    }
 ...
 * herr_t (*close)(void*,hid_t,void**);
    ...
    public interface close {
        ...
        static MemorySegment allocate(close fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$305.const$2, fi, constants$18.const$0, scope);
        }
    ...
    public static MemorySegment close$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$305.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment close$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$305.const$3.get(seg.asSlice(index*sizeof()));
    }
