...
public class H5FD_free_t {
    ...
    public static long addr$get(MemorySegment seg) {
        return (long)constants$197.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long addr$get(MemorySegment seg, long index) {
        return (long)constants$197.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long size$get(MemorySegment seg) {
        return (long)constants$197.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long size$get(MemorySegment seg, long index) {
        return (long)constants$197.const$2.get(seg.asSlice(index*sizeof()));
    }
