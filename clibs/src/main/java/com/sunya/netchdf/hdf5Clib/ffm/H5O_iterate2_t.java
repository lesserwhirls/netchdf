...
/**
 * {@snippet :
 * int (*H5O_iterate2_t)(long obj,char* name,struct H5O_info2_t* info,void* op_data);
 * }
 */
public interface H5O_iterate2_t {
    ...
    static MemorySegment allocate(H5O_iterate2_t fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$76.const$2, fi, constants$61.const$0, scope);
    }
    static H5O_iterate2_t ofAddress(MemorySegment addr, Arena arena) {
