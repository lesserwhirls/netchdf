 ...
 * void* (*create)(void*,const H5VL_loc_params_t*,char*,hid_t,hid_t,hid_t,hid_t,hid_t,void**);
    ...
    public interface create {
        ...
        static MemorySegment allocate(create fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$260.const$2, fi, constants$260.const$1, scope);
        }
        static create ofAddress(MemorySegment addr, Arena arena) {
            ...
            return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1, java.lang.foreign.MemorySegment __x2, long __x3, long __x4, long __x5, long __x6, long __x7, java.lang.foreign.MemorySegment __x8) -> {
                try {
                    return (java.lang.foreign.MemorySegment)constants$260.const$3.invokeExact(symbol, __x0, __x1, __x2, __x3, __x4, __x5, __x6, __x7, __x8);
                } catch (Throwable ex$) {
    ...
    public static MemorySegment create$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$260.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment create$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$260.const$4.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void* (*open)(void*,const H5VL_loc_params_t*,char*,hid_t,hid_t,void**);
    ...
    public interface open {
        ...
        static MemorySegment allocate(open fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$261.const$0, fi, constants$260.const$5, scope);
        }
    ...
    public static MemorySegment open$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$261.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment open$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$261.const$2.get(seg.asSlice(index*sizeof()));
    }
 ...
 * herr_t (*read)(void*,hid_t,void*,hid_t,void**);
    ...
    public interface read {
        ...
        static MemorySegment allocate(read fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$261.const$4, fi, constants$261.const$3, scope);
        }
        static read ofAddress(MemorySegment addr, Arena arena) {
            ...
            return (java.lang.foreign.MemorySegment __x0, long __x1, java.lang.foreign.MemorySegment __x2, long __x3, java.lang.foreign.MemorySegment __x4) -> {
                try {
                    return (int)constants$261.const$5.invokeExact(symbol, __x0, __x1, __x2, __x3, __x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemorySegment read$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$262.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void read$set(MemorySegment seg, MemorySegment x) {
        constants$262.const$0.set(seg, x);
    }
    public static MemorySegment read$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$262.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void read$set(MemorySegment seg, long index, MemorySegment x) {
        constants$262.const$0.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * herr_t (*write)(void*,hid_t,void*,hid_t,void**);
    ...
    public interface write {
        ...
        static MemorySegment allocate(write fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$262.const$1, fi, constants$261.const$3, scope);
        }
    ...
    public static MemorySegment write$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$262.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment write$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$262.const$2.get(seg.asSlice(index*sizeof()));
    }
 ...
 * herr_t (*get)(void*,H5VL_attr_get_args_t*,hid_t,void**);
    ...
    public interface get {
        ...
        static MemorySegment allocate(get fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$262.const$4, fi, constants$262.const$3, scope);
        }
 ...
 * herr_t (*specific)(void*,const H5VL_loc_params_t*,H5VL_attr_specific_args_t*,hid_t,void**);
    ...
    public interface specific {
        ...
        static MemorySegment allocate(specific fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$263.const$2, fi, constants$263.const$1, scope);
        }
    ...
    public static MemorySegment specific$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$263.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment specific$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$263.const$4.get(seg.asSlice(index*sizeof()));
    }
 ...
 * herr_t (*optional)(void*,H5VL_optional_args_t*,hid_t,void**);
    ...
    public interface optional {
        ...
        static MemorySegment allocate(optional fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$263.const$5, fi, constants$262.const$3, scope);
        }
    ...
    public static MemorySegment optional$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$264.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment optional$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$264.const$0.get(seg.asSlice(index*sizeof()));
    }
 ...
 * herr_t (*close)(void*,hid_t,void**);
    ...
    public interface close {
        ...
        static MemorySegment allocate(close fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$264.const$1, fi, constants$17.const$2, scope);
        }
    ...
    public static MemorySegment close$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$264.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment close$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$264.const$2.get(seg.asSlice(index*sizeof()));
    }
