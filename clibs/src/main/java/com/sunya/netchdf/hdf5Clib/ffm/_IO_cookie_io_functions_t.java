...
public class _IO_cookie_io_functions_t {
    ...
    public static MemorySegment read$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$116.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment read$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$116.const$1.get(seg.asSlice(index*sizeof()));
    }
