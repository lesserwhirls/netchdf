 ...
 *     herr_t (*get)(void*,H5VL_file_get_t,hid_t,void**,struct __va_list_tag*);
 *     herr_t (*specific)(void*,H5VL_file_specific_t,hid_t,void**,struct __va_list_tag*);
 *     herr_t (*optional)(void*,H5VL_file_optional_t,hid_t,void**,struct __va_list_tag*);
 ...
 * void* (*create)(char*,unsigned int,hid_t,hid_t,hid_t,void**);
    ...
    public interface create {
        ...
        static MemorySegment allocate(create fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$300.const$4, fi, constants$300.const$3, scope);
        }
        static create ofAddress(MemorySegment addr, Arena arena) {
            ...
            return (java.lang.foreign.MemorySegment __x0, int __x1, long __x2, long __x3, long __x4, java.lang.foreign.MemorySegment __x5) -> {
                try {
                    return (java.lang.foreign.MemorySegment)constants$300.const$5.invokeExact(symbol, __x0, __x1, __x2, __x3, __x4, __x5);
                } catch (Throwable ex$) {
 ...
 * void* (*open)(char*,unsigned int,hid_t,hid_t,void**);
    ...
    public interface open {
        ...
        static MemorySegment allocate(open fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$301.const$2, fi, constants$301.const$1, scope);
        }
        static open ofAddress(MemorySegment addr, Arena arena) {
            ...
            return (java.lang.foreign.MemorySegment __x0, int __x1, long __x2, long __x3, java.lang.foreign.MemorySegment __x4) -> {
                try {
                    return (java.lang.foreign.MemorySegment)constants$301.const$3.invokeExact(symbol, __x0, __x1, __x2, __x3, __x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * herr_t (*get)(void*,H5VL_file_get_t,hid_t,void**,struct __va_list_tag*);
    ...
    public interface get {
        ...
        static MemorySegment allocate(get fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$301.const$5, fi, constants$292.const$4, scope);
        }
 ...
 * herr_t (*specific)(void*,H5VL_file_specific_t,hid_t,void**,struct __va_list_tag*);
    ...
    public interface specific {
        ...
        static MemorySegment allocate(specific fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$302.const$1, fi, constants$292.const$4, scope);
        }
 ...
 * herr_t (*optional)(void*,H5VL_file_optional_t,hid_t,void**,struct __va_list_tag*);
    ...
    public interface optional {
        ...
        static MemorySegment allocate(optional fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$302.const$3, fi, constants$292.const$4, scope);
        }
    ...
    public static MemorySegment optional$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$302.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment optional$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$302.const$4.get(seg.asSlice(index*sizeof()));
    }
 ...
 * herr_t (*close)(void*,hid_t,void**);
    ...
    public interface close {
        ...
        static MemorySegment allocate(close fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$302.const$5, fi, constants$18.const$0, scope);
        }
