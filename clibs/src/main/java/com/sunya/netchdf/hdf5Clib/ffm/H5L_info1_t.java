...
public class H5L_info1_t {
    ...
    public static boolean corder_valid$get(MemorySegment seg) {
        return (boolean)constants$68.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static boolean corder_valid$get(MemorySegment seg, long index) {
        return (boolean)constants$68.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long corder$get(MemorySegment seg) {
        return (long)constants$68.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long corder$get(MemorySegment seg, long index) {
        return (long)constants$68.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static final class u {
        ...
        public static long address$get(MemorySegment seg) {
            return (long)constants$68.const$5.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static long address$get(MemorySegment seg, long index) {
            return (long)constants$68.const$5.get(seg.asSlice(index*sizeof()));
        }
