...
public class _IO_FILE {
    ...
    public static byte _vtable_offset$get(MemorySegment seg) {
        return (byte)constants$15.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte _vtable_offset$get(MemorySegment seg, long index) {
        return (byte)constants$15.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long __pad5$get(MemorySegment seg) {
        return (long)constants$16.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long __pad5$get(MemorySegment seg, long index) {
        return (long)constants$16.const$1.get(seg.asSlice(index*sizeof()));
    }
