...
fun convertToBytes(datatype : Datatype<*>, value: Any?, isBE: Boolean): ByteArray {
...
fun convertFromBytes(datatype : Datatype<*>, ba: ByteArray, isBE: Boolean): Any {
