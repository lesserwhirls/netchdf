...
/**
 * {@snippet :
 * int (*H5L_iterate1_t)(long group,char* name,struct * info,void* op_data);
 * }
 */
public interface H5L_iterate1_t {
    ...
    static MemorySegment allocate(H5L_iterate1_t fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$199.const$0, fi, constants$27.const$0, scope);
    }
    static H5L_iterate1_t ofAddress(MemorySegment addr, Arena arena) {
