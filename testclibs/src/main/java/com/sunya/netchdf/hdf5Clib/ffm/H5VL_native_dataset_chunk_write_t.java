 ...
 * }
 */
public class H5VL_native_dataset_chunk_write_t {
    ...
    public static MemorySegment offset$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$417.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment offset$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$417.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int filters$get(MemorySegment seg) {
        return (int)constants$417.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int filters$get(MemorySegment seg, long index) {
        return (int)constants$417.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment buf$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$417.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment buf$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$417.const$3.get(seg.asSlice(index*sizeof()));
    }
