...
public class H5E_error1_t {
    ...
    public static long maj_num$get(MemorySegment seg) {
        return (long)constants$163.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long maj_num$get(MemorySegment seg, long index) {
        return (long)constants$163.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment desc$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$163.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment desc$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$163.const$5.get(seg.asSlice(index*sizeof()));
    }
