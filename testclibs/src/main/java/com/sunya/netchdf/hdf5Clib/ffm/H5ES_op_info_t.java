...
public class H5ES_op_info_t {
    ...
    public static MemorySegment api_name$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$166.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment api_name$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$166.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment app_file_name$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$166.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment app_file_name$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$166.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long op_ins_count$get(MemorySegment seg) {
        return (long)constants$166.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long op_ins_count$get(MemorySegment seg, long index) {
        return (long)constants$166.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long op_ins_ts$get(MemorySegment seg) {
        return (long)constants$167.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long op_ins_ts$get(MemorySegment seg, long index) {
        return (long)constants$167.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long op_exec_ts$get(MemorySegment seg) {
        return (long)constants$167.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long op_exec_ts$get(MemorySegment seg, long index) {
        return (long)constants$167.const$1.get(seg.asSlice(index*sizeof()));
    }
