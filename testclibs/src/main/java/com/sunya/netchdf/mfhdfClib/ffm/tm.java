...
public class tm {
    ...
    public static long tm_gmtoff$get(MemorySegment seg) {
        return (long)constants$83.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long tm_gmtoff$get(MemorySegment seg, long index) {
        return (long)constants$83.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment tm_zone$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$83.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment tm_zone$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$83.const$1.get(seg.asSlice(index*sizeof()));
    }
