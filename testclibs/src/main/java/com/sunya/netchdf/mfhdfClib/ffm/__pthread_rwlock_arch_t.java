...
public class __pthread_rwlock_arch_t {
    ...
    public static int __cur_writer$get(MemorySegment seg) {
        return (int)constants$47.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int __cur_writer$get(MemorySegment seg, long index) {
        return (int)constants$47.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int __shared$get(MemorySegment seg) {
        return (int)constants$47.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int __shared$get(MemorySegment seg, long index) {
        return (int)constants$47.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte __rwelision$get(MemorySegment seg) {
        return (byte)constants$47.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte __rwelision$get(MemorySegment seg, long index) {
        return (byte)constants$47.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long __pad2$get(MemorySegment seg) {
        return (long)constants$48.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long __pad2$get(MemorySegment seg, long index) {
        return (long)constants$48.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int __flags$get(MemorySegment seg) {
        return (int)constants$48.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int __flags$get(MemorySegment seg, long index) {
        return (int)constants$48.const$1.get(seg.asSlice(index*sizeof()));
    }
